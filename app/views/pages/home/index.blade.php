@section('content')
    ...
    <div class="sixteen wide column">
        ...
        <div class="ui bottom attached active tab segment" data-tab="classes">At MST Gym we incorporate a fun and motivation group atmosphere with expert class instructors
          ...
          a group fitness class that suits your goals and your schedule. Each member will receive an amount of classes based on their membership. </div>
        ...
        bouts. We scale load and intensity; we don’t change programs.</div>
        ...
        and mind. Pilates is physiologically efficient as it is full body focused, coupled with the use of the breath and optimized activation of the inner muscles of the body's core.</div>
        ...
        through grueling hill climbs, flat terrain, head winds, tail winds and anaerobic intervals.</div>
